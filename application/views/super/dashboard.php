                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="dash-box dash-box-3">
                            ...
                            <h1><?= f_number($party->client_due) ?></h1>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="dash-box dash-box-2">
                            ...
                            <h1><?= f_number($party->supplier_due) ?></h1>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <table class="table table-bordered">
                            ...
                            <?php foreach ($rawStockAlert as $_key => $item) { ?>
                                <tr>
                                    <td><?= ++$_key ?></td>
                                    <td><?= $item->code ?></td>
                    ...
                    <div class="col-md-6">
                        <table class="table table-bordered">
                            ...
                            <?php foreach ($finishStockAlert as $_key => $item) { ?>
                                <tr>
                                    <td><?= ++$_key ?></td>
                                    <td><?= $item->code ?></td>
                                    <td><?= filter($item->name) ?></td>
