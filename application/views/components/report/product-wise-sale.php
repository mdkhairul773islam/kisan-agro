...
<div class="panel panel-default">
    <div class="panel-heading none">
        <div class="panal-header-title">
            <h1 class="pull-left">Product Wise Sale Report</h1>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <div class="input-group date" id="datetimepickerFrom">
                        <input type="text" name="date" value="<?= !empty($_POST['date']) ? $_POST['date'] : date('Y-m-d') ?>" placeholder="From ( YYYY-MM-DD )" class="form-control" required>
        ...
        <?php if (!empty($result)) { ?>
            <table class="table table-bordered " id="DataTable">
                ...
                <tr>
                    ...
                    <th width="140">Total Sale Amount (Tk)</th>
                    <th>Damage Amount (Tk)</th>
                </tr>
                </thead>

                <tbody>
                <?php
                $totalQuantity = $totalWeight = $totalAmount = $total_damage_amount = 0;
                foreach ($result as $key => $row) {
                    $product_wise_damage_amount = 0;
                    
                    $where_damage_product = ['product_code'=>$row->code];
                    ...
                    $total_damage_amount += $product_wise_damage_amount;
                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center" >
                            <?php echo f_number($product_wise_damage_amount);  ?>
                        </td>    
                    </tr>
                <?php } ?>
                <tr>
                    ...
                    <th class="text-center"> <?php echo f_number($totalAmount); ?> </th>
                    <th class="text-center"><?php  echo f_number($total_damage_amount); ?> </th>
                </tr>
