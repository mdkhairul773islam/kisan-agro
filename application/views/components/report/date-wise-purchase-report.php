                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        foreach ($result as $key => $row) {
                            ...
                            $where                = ['sap_at' => $row->sap_at, 'status' => 'purchase', 'trash' => 0];
                            $where_damage_product = ['created_at' => $row->sap_at, 'status' => 'purchase_damage', 'trash' => 0];

                            $saprecordsInfo = get_row('saprecords', $where, "SUM(total_bill + transport_cost - total_discount) AS total_bill, SUM(paid) AS paid");
