...
<div class="container-fluid" ng-controller="makeRecipeCtrl">
    <div class="row" ng-cloak>
        ...
        <div class="panel panel-default">
            ...
            <!-- horizontal form -->
            <?php
            $categoryCode = !empty($_GET['category']) ? $_GET['category'] : '';
            $totalWeight = !empty($_GET['weight']) ? $_GET['weight'] : '';
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <?php
                          /*  echo '<pre>';
                            print_r($allCategory);*/
                        ?>
                        <select name="category_code" ng-init="category_code='<?php echo $categoryCode; ?>'"  ng-model="category_code" class="form-control" required>
                    ...
                    <div class="col-md-4">
                        <input type="text" name="flour" class="form-control"
                               ng-init="flower='<?php echo $totalWeight; ?>'"
                               ng-model="flower"
