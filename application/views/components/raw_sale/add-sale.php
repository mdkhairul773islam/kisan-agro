...
<div class="container-fluid" ng-controller="RawSaleEntryCtrl">
    <div class="row">
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input type="number" name="meta[truck_fare]" ng-model="amount.truck_rent" min="0" class="form-control">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-3 control-label">Commission(%) <span class="req">*</span></label>
                                <div class="col-md-4">
                                    <select class="form-control" name="meta[commission]" ng-model="commission" ng-change="calculateTotalCommission();" required>
                                        <option value="" selected disabled>&nbsp;</option>
                                        <?php for ($i=0; $i<=6 ; $i++) {  ?>
