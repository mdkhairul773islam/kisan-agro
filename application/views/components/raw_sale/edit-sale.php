...
<div class="container-fluid" ng-controller="EditRawSaleEntryCtrl">
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" ng-cloak>
                ...
                echo form_open('raw_sale/saleEditCtrl?vno=' . $this->input->get('vno'), $attr);
                ?>
