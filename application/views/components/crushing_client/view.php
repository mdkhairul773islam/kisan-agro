        ...
        <div class="panel panel-default ">
            ...
            <?php 
                foreach ($partyinfo as $key => $row) {
                    ...
                    $balanceinfo    = $this->action->read('crushing_partybalance', $where);
                }
             ?>
            <div class="panel-body">
                ...
                <div class="row">
                	...
                	<div class="col-xs-4 print-font">
                		<label>Date : <?php echo $partyinfo[0]->transaction_at; ?></label> <br>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td><?php echo $partyinfo[0]->paid; ?></td>
                        <td><?php echo ucfirst($partyinfo[0]->transaction_via); ?></td>
                        <td><?php echo $balanceinfo[0]->balance; ?></td>
                        <td><?php echo ucfirst($partyinfo[0]->remark); ?></td>
                    </tr>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#inword").html(inWorden(<?php echo $partyinfo[0]->paid; ?>));
    });
</script>
