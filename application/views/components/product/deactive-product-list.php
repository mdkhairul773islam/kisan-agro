        ...
        <div class="panel panel-default">
            <div class="panel-heading panal-header">
                <div class="panal-header-title">
                    <h1 class="pull-left">Unavailable All Product</h1>
            ...
            <div class="panel-body none">
                <?php
                    ...
                    echo form_open("product/product/deactive_product");
                ?>
                <div class="row">
                    <div class="col-md-3">
            ...
            <div class="panel-body">
                ...
                <h4 class="hide text-center" style="margin-top: 0px;">Product List</h4>
                                ...
                                <td class="none">
                                    ...
                                    <?php if ($this->session->userdata['privilege'] !== "user") { ?>
                                        <a class="btn btn-danger" title="Delete"
                                           ...
                                           href="<?php echo site_url('product/product/delete/' . $row->code); ?>">
