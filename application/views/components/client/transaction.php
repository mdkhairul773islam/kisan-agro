    ...
    <div class="row" ng-controller="clientTransactionCtrl" ng-cloak>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                echo form_open('client/transaction/store', $attr);
                ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <select name="code" ng-model="code" class="selectpicker form-control"  ng-change="getclientInfo(code);" required data-show-subtext="true" data-live-search="true" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="number" ng-model="balance" class="form-control" step="any" readonly>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <select name="transaction_type" ng-init="transactionType='received'" ng-model="transactionType" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="number" name="payment" ng-model="payment" class="form-control" step="any" min="0" placeholder="0" required>
                    </div>
                </div>
                ...
                <div class="form-group" ng-show="transactionType=='received'">
                    ...
                    <div class="col-md-5">
                        <input type="number" name="remission" ng-model="remission" class="form-control" step="any" placeholder="0">
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <input type="number" ng-value="getTotalFn()" class="form-control" step="any" readonly>
