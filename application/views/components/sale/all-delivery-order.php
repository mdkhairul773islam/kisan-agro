    ...
    <div class="row">
        ...
        <div class="panel panel-default">
                ...
                <div class="row none">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <select name="search[party_code]" class="selectpicker mb-5 form-control"
            ...
            <div class="panel-body">
                ...
                <h4 class="text-center hide" style="margin-top: 0px;">All Delivery Order</h4>
                <?php
                if (!empty($allOrder)) { ?>
                            ...
                            <tr>
                                ...
                                <td class="none text-center">
                                    ...
                                    <a title="View" class="btn btn-primary"
                                       href="<?php echo site_url("sale/order/sale_voucher/$row->voucher_no"); ?>">
                                    ...
                                    <?php if(!checkAuth('user')){ ?>
                                        <a title="Delete"
                                           ...
                                           href="<?php echo site_url("sale/order/deleteDeliverOrder/$row->voucher_no"); ?>">
