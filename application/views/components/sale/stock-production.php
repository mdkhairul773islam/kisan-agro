        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body none">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <select name="status" class="form-control mb-5" required>
                                <option value="pending" <?= (!empty($_POST['status']) && $_POST['status'] == "pending" ? "selected" : "") ?>>
                                    Pending
                                </option>
                                <option value="processing" <?= (!empty($_POST['status']) && $_POST['status'] == "processing" ? "selected" : "") ?>>
                                    Processing
                                </option>
                                <option value="stock" <?= (!empty($_POST['status']) && $_POST['status'] == "stock" ? "selected" : "") ?>>
                                    Stock
                                </option>
                            </select>
                        </div>
            ...
            <div class="panel-body">
                ...
                <?php if (!empty($result)) { ?>
                    ...
                    <table class="table table-bordered " id="DataTable">
                        ...
                        <tbody>
                        <?php
                        $totalWeight = $totalQuantity = $totalAmount = 0;
                        foreach ($result as $key => $row) {?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    $amount = $saleQty * $row->purchase_price;
                                    $totalAmount += $amount;
                                ...
                                <td><?php  echo f_number($amount, 3); ?></td>
                            </tr>
                        <?php } ?>
                        <tr>
                            ...
                            <th> <?php echo f_number($totalAmount, 3); ?> </th>
                        </tr>
