            ...
            <div class="panel-body" ng-cloak>
                ...
                <table class="table table-bordered table2">
                    ...
                    <tr ng-repeat="item in records">
                        ...
                        <td>
                            <input type="number" name="new_quantity[]" class="form-control" ng-model="item.newQuantity" step="any" min="0" max="{{ item.oldQuantity }}">
                        </td>


                        <td>
                            <select class="form-control" name="bagSize[]" ng-model="item.bag_size" ng-change="calculateBags($index,bag_size);" readonly>
                        ...
                        <td>
                            <input type="number" name="new_sale_price[]" class="form-control" min="0" ng-model="item.newSalePrice" step="any" readonly>
                        </td>
                ...
                <div class="row">
                    <div class="col-md-6">
                      <!--previous total value start here -->
                        ...
                        <input type="hidden" name="old_grand_total" class="form-control" ng-value="amount.oldTotal" step="any" readonly>
                       ...
                       <div class="row">
                         <div class="col-md-12">
                           <div class="form-group">
                               ...
                               <div class="col-md-9">
                                   <input type="number" name="meta[truck_fare]" ng-model="amount.truck_rent" class="form-control" readonly>
                           ...
                           <div class="form-group">
                               ...
                               <div class="col-md-4">
                                   <input type="text" class="form-control" name="meta[commission]" ng-model="commission"  readonly>
                    ...
                    <div class="col-md-6">
                    	...
                    	<div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="number"  ng-value="getOldGrandTotalFn()" class="form-control" step="any" readonly>
                            </div>
                        </div>
                        ...
                        <!--div class="form-group">
                            <label class="col-md-4 control-label"> Return Money <span class="req">*</span></label>
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-7">
                ...
                <div class="btn-group pull-right">
                    <input type="submit" name="change" value="Return" class="btn btn-primary">
                </div>
