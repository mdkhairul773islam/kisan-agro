        ...
        <div class="panel panel-default">
            <div class="panel-heading panal-header">
                <div class="panal-header-title pull-left">
                    <h1>Add New Client Order</h1>
                </div>
                <div class="panal-header-title pull-left">
                    <p style="color: red;font-weight:bold; margin-left: 25px;"><?php if (!empty($last_voucher)) {
            ...
            <div class="panel-body" ng-cloak>
                ...
                <?php
                    $attr = array('id' => 'form');
                    echo form_open('sale/order/storeOrder', $attr);
                ?>

                <input type="hidden" ng-init="stockType='stock'" ng-model="stockType" ng-value="stock">
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group mb-5">
                            <div class="input-group date" id="datetimepicker">
                                <input type="text" name="sap_at" value="<?php echo date("Y-m-d"); ?>" class="form-control" placeholder="YYYY-MM-DD" required>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <select name="party_code" ng-model="partyCode" ng-change="findPartyFn()" class="selectpicker form-control" data-show-subtext="true" data-live-search="true" ng-required="true">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <select class="selectpicker form-control" ng-init="showroom_id='<?php echo $branch; ?>'" ng-model="productCode" ng-change="addNewProductFn()" data-show-subtext="true" data-live-search="true" required>
                ...
                <table class="table table-bordered table2">
                    ...
                    <tr ng-repeat="item in cart">
                        ...
                        <td class="td-input">
                            {{ item.stock_type  }}
                            <input type="hidden" name="stock_type[]" ng-value="item.stock_type" class="form-control" readonly>
                        </td>
                        
                        <td>
                            <input type="text" name="quantity[]" class="form-control" ng-model="item.quantity" ng-required="true" placeholder="0" autocomplete="off">
                        </td>
                ...
                <div class="btn-group pull-right">
                    <input type="submit" name="save" value="Save" class="btn btn-primary" ng-hide="isDisabled">
                </div>
