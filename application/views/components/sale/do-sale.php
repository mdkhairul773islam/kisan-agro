<script src="<?php echo site_url('private/js/ngscript/doSaleController.js?').time(); ?>"></script>
<style>  
	.table2 tr td {
		padding: 0 !important;
	}
...
<div class="container-fluid" ng-controller="doSaleController" ng-cloak>
   <div class="row">
               ...
               <div class="col-md-6">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-9">
                        ...
                        <select ui-select2="{ allowClear: true }" class="form-control" name="party_code" ng-model="party_code" ng-change="findPartyFn(party_code)" data-placeholder="Select Client" required>
                           <option value="" selected disable> </option>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-9">
                        <input type="text" name="mobile" ng-value="partyInfo.mobile" class="form-control" readonly>
                     </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group" ng-if="!dueLimitCheck">
                     ...
                     <div class="col-md-9">
                        <input type="text" name="due_limit_reference" class="form-control" placeholder="Reference" required>
                     </div>
                  </div>
               </div>
               <div class="col-md-6">
