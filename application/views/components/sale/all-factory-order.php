                                    ...
                                    <td class="none text-center">
                                        ...
                                        if (!empty($status)) {
                                            if ($status[0]->status == 'processing' && count($status) == 1) { ?>
                                                <a title="Add Stock" class="btn btn-success"
                                                   href="<?php echo site_url("sale/factory_order/sale/$row->voucher_no"); ?>">
                                        ...
                                        <a title="View" class="btn btn-primary"
                                           href="<?php echo site_url("sale/factory_order/preview/$row->voucher_no"); ?>">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                        </a>

                                        <a title="Edit" class="btn btn-warning"
                                           href="<?php echo site_url("sale/factory_order/edit/$row->voucher_no"); ?>">
                                        ...
                                        <?php if ($this->session->userdata['privilege'] !== "user") { ?>
                                            <a title="Delete"
                                               ...
                                               href="<?php echo site_url("sale/factory_order/delete/$row->voucher_no"); ?>">
