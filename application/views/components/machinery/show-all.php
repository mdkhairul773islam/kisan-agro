        ...
        <?php if (!empty($result)) { ?>
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <h4 class="text-center hide" style="margin-top: 0px;">All Used Machinery</h4>
                            ...
                            <tr>
                                ...
                                <td class="none">
                                    <a title="View" class="btn btn-primary"
                                       href="<?php echo site_url('machinery/used/preview/' . $row->voucher_no); ?>">
                                        <i class="fa fa-eye" aria-hidden="true"></i>
                                    </a>

                                    <a onclick="return confirm('Are you sure want to delete this Sale?');" title="Delete" class="btn btn-danger" href="<?php echo site_url('machinery/used/delete/' . $row->voucher_no); ?>">
