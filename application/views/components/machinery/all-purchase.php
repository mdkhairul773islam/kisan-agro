                        ...
                        foreach($result as $key => $val){
                            ...
                            <tr>
                                ...
                                <td class="none text-center" style="width: 162px;">
                                    <a title="View" class="btn btn-primary" href="<?php echo site_url('machinery/purchase/preview_voucher?vno=' . $val->voucher_no); ?>">
                                        <i class="fa fa-eye" aria-hidden="true"></i>
                                    </a>
                                    
                                    <?php if ($val->sap_at == date('Y-m-d')){ ?>

                                    <a title="Edit/Return" class="btn btn-warning" href="<?php echo site_url('machinery/edit_purchase?vno=' . $val->voucher_no); ?>">
                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                    </a>

                                    <?php if($this->session->userdata['privilege'] !== "user"){ ?>
                                        <a title="Delete" class="btn btn-danger" onclick="return confirm('Are you sure want to delete this Data?');" href="<?php echo site_url('machinery/purchase/delete_purchase?vno=' . $val->voucher_no); ?>">
