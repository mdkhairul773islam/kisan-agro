                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="btn-group">
                            ...
                            <a href="<?= site_url('damages/damages/view_all') ?>" class="btn btn-success"><i
                                ...
                                <tr>
                                    ...
                                    <td class="none">
                                        <a title="View" class="btn btn-primary"
                                           href="<?php echo site_url('damages/damages/preview?vno=' . $row->voucher_no); ?>">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                        </a>

                                        <a onclick="return confirm('Are you sure want to delete this Sale Return?');"
                                           title="Delete" class="btn btn-danger"
                                           href="<?php echo site_url('damages/damages/delete?vno=' . $row->voucher_no); ?>">
