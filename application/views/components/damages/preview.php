        ...
        <div class="panel panel-default ">
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered">
                    ...
                    <?php
                    $where    = ['sapreturn_items.voucher_no' => $info->voucher_no, 'sapreturn_items.trash' => 0, 'stock.type' => 'finish_product'];
                    ...
                    <tr>
                        ...
                        <td class="text-right"><?= get_number_format((($info->previous_balance - $totalAmount))) ?></td>
                    </tr>
                </table>
