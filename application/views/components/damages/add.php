...
<div class="container-fluid" ng-controller="DamageAddController">
    <div class="row">
	   <?php echo $this->session->flashdata('confirmation'); ?>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" ng-cloak>
                ...
                echo form_open('damages/damages/store', $attr);
                ?>
                <div class="row">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-4">
                        <select
                            name="party_code"
                            ng-model="party_code"
                            ng-change="findPartyFn(party_code)"
                    ...
                    <div class="col-md-4">
                        <select ng-model="product_code" class="selectpicker form-control" ng-change="addNewProductFn(product_code)"
                ...
                <table class="table table-bordered table2" ng-cloak>
                    ...
                    <tr ng-repeat="item in cart">
                        ...
                        <td>
                            <input type="text" name="quantity[]" class="form-control" ng-model="item.quantity" max="{{ item.stock_qty }}" autocomplete="off" ng-required="true">
                        </td>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="hidden" name="client_type" ng-model="partyInfo.client_type"
                                       ng-value="partyInfo.client_type">
                            </div>
                        </div>
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-7">
                                        ...
                                        <input type="hidden" name="previous_balance" ng-model="partyInfo.balance" ng-value="partyInfo.balance"
