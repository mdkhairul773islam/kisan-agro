            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-xs-4 print-font">
                        <label>Name : <?= get_filter($info->name) ?></label>
                        <label>Mobile : <?= $info->mobile ?></label>
                    </div>
                ...
                <table class="table table-bordered">
                    ...
                    <?php
                    $where    = ['sapreturn_items.voucher_no' => $info->voucher_no, 'sapreturn_items.trash' => 0];
                    $select   = ['sapreturn_items.*', 'stock.name'];
                    ...
                    if (!empty($saleInfo)) {
                        foreach ($saleInfo as $key => $row) {
                            ...
                            <tr>
                                ...
                                <td class="text-right"> <?= $row->total_weight ?> </td>
                                <td class="text-right"> <?= $row->purchase_price ?> </td>
                                <td class="text-right"> <?= $subTotal ?> </td>
                            </tr>
                        <?php }

                        $current_balance = round($totalAmount) + $info->previous_balance;
                    } ?>

                    <tr>
                        <th rowspan="4" colspan="5" style="vertical-align: middle">
                    ...
                    <tr>
                        ...
                        <td class="text-right"><?= get_number_format(round($totalAmount)) ?></td>
                    </tr>

                    <tr>
                        <th class="text-right"> Previous Balance</th>
                        <td class="text-right"><?= get_number_format($info->previous_balance) ?></td>
                    </tr>

                    <tr>
                        <th class="text-right"> Current Balance</th>
                        <td class="text-right"><?= get_number_format($current_balance) ?></td>
                    </tr>
                </table>
                <p><strong>Specification:</strong> <?= $info->specification; ?> </p>
