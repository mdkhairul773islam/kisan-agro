    ...
    <div class="row">
                        ...
                        <div class="form-group">
                            <div class="input-group date" id="datetimepickerFrom">
                                <input type="text" name="dateFrom" class="form-control"
                                       value="<?php echo(!empty($_POST['dateFrom']) ? $_POST['dateFrom'] : ''); ?>" placeholder="Date From">
                        ...
                        <div class="form-group">
                            <div class="input-group date" id="datetimepickerTo">
                                <input type="text" name="dateTo" class="form-control"
                                       value="<?php echo(!empty($_POST['dateTo']) ? $_POST['dateTo'] : ''); ?>" placeholder="Date To">
                                <span class="input-group-addon">
                            <span class="glyphicon glyphicon-calendar"></span>
                        </span>
                            </div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <h4 class="text-center hide" style="margin-top: 0px;">Item Wise All Purchase</h4>
