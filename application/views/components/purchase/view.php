            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered">
                    <tr>
                        ...
                        <th>Raw Materials</th>
                        <th style="width: 75px;" class="text-right">Quantity</th>
                        <th style="width: 75px;" class="text-right">Price</th>
                        <th style="width: 75px;" class="text-right">Discount</th>
                    ...
                    <tr>
                        ...
                        <th class="text-right"><?php echo f_number($voucherInfo->total_discount); ?></th>
                    </tr>
                    <tr>
