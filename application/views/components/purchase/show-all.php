        ...
        <?php if (!empty($result)) { ?>
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <h4 class="text-center hide" style="margin-top: 0px;">All Packaging</h4>
                            ...
                            <tr>
                                ...
                                <td class="none">
                                    <a title="View" class="btn btn-primary"
                                       href="<?php echo site_url('purchase/used/preview/' . $row->voucher_no); ?>">
                                    ...
                                    <a onclick="return confirm('Are you sure want to delete this Sale?');"
                                       ...
                                       href="<?php echo site_url('purchase/used/delete/' . $row->voucher_no); ?>">
