            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-3 mb-1">
                        <input type="text" name="search[voucher_no]" value="<?= (!empty($_POST['search']['voucher_no']) ? $_POST['search']['voucher_no'] : '') ?>" class="form-control" placeholder="Voucher No">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="btn-group">
                            ...
                            <a href="<?= site_url('purchase/purchase_return/all') ?>" class="btn btn-success"><i
                                ...
                                <tr>
                                    ...
                                    <td class="none">
                                        <a title="View" class="btn btn-primary"
                                           href="<?php echo site_url('purchase/purchase_return/view?vno=' . $row->voucher_no); ?>">
                                            <i class="fa fa-eye" aria-hidden="true"></i>
                                        </a>

                                        <a onclick="return confirm('Are you sure want to delete this Sale Return?');"
                                           title="Delete" class="btn btn-danger"
                                           href="<?php echo site_url('purchase/purchase_return/delete?vno=' . $row->voucher_no); ?>">
