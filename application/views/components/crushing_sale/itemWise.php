        ...
        <div class="panel panel-default none">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label class="col-md-2 control-label">Raw Products </label>
                    <div class="col-md-4">
                        <select name="product_code" class="form-control js-example-basic-single" reaquired>
                            <option value="">--Select--</option> 
                            <?php if($raw != null){ foreach($raw as $key => $row){ ?>
                  ...
                  <table class="table table-bordered table2">
                       ...
                       ?>
                        ...
                        <tr>
                            ...
                            <td class="none">
                                <a title="View" class="btn btn-primary" href="<?php echo site_url('crushing_sale/viewCrushingSale?vno=' . $val->voucher_no); ?>">
