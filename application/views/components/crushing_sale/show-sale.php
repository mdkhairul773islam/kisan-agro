    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <h4 class="text-center hide" style="margin-top: 0px;">All Crushing Sales</h4>
                ...
                <table class="table table-bordered table2">
                    ...
                    <tr>
                        ...
                        <td class="none" style="width: 170px;">
                            <a title="View" class="btn btn-primary" href="<?php echo site_url('crushing_sale/viewCrushingSale?vno=' . $row->voucher_no); ?>">
                            ...
                            <a
                                ...
                                href="<?php echo site_url('crushing_sale/saleEditCtrl?vno=' . $row->voucher_no); ?>">
