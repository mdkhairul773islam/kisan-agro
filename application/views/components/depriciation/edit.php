	...
	<?php echo $this->session->flashdata('confirmation'); ?>
        <div class="panel panel-default">
            ...
            <?php   $attr = array('class' =>'form-horizontal');
                    echo form_open('depriciation/depriciation/edit/'.$result[0]->id, $attr); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date col-md-5" id="datetimepicker1">
                        <input type="text" name="date" value="<?= $result[0]->date ?>" class="form-control" required>
                    ...
                    <div class="col-md-5">
                        <select name="godown_code" class="selectpicker form-control" data-show-subtext="true" data-live-search="true">
                            ...
                            <option 
                                ...
                                <?php if($value->code==$result[0]->godown_code){echo "selected";} ?>>
                                <?php echo $value->name; ?>
                            </option>
                            <?php } ?>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <input type="number" value="<?= $result[0]->amount ?>" name="amount" step="any" placeholder="" class="form-control" required>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <textarea name="particulars" class="form-control" rows="5" required><?= $result[0]->particulars ?></textarea>
                    </div>
                </div>
