...
class Used extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        //get all Product
        $this->data['allProducts'] = get_join('stock', 'materials', 'stock.code=materials.code AND stock.type=materials.type', ['stock.type' => 'raw', 'materials.raw_type' => 'machinery'], ['stock.code', 'stock.name']);
        ...
        $this->load->view('components/machinery/used-create', $this->data);
    ...
    {
        $this->data['subMenu']      = 'data-target="show"';
        $this->data['confirmation'] = null;
        ...
        $this->load->view($this->data['privilege'] . '/includes/headermenu', $this->data);
        $this->load->view('components/machinery/nav', $this->data);
        $this->load->view('components/machinery/show-all', $this->data);
        $this->load->view($this->data['privilege'] . '/includes/footer');
    }
    ...
    public function item_wise()
    {
        ...
        // get all data
        $this->data['result'] = $this->item_search();
        ...
        $this->load->view($this->data['privilege'] . '/includes/headermenu', $this->data);
        $this->load->view('components/machinery/nav', $this->data);
        $this->load->view('components/machinery/item-wise-used', $this->data);
        $this->load->view($this->data['privilege'] . '/includes/footer');
    }
    ...
    {
        // get all result
        $where = ['tbl_packaging.trash' => 0, 'materials.raw_type' => 'machinery'];
        if (isset($_POST['show'])) {
        ...
        $select   = ['tbl_packaging.*', 'materials.raw_type'];
        $data     = get_join('tbl_packaging', $tableTo, $joinCond, $where, $select, ['tbl_packaging_items.voucher_no', 'materials.raw_type'], 'id', 'desc');
    ...
    public function preview($voucher_no = null)
    {
        ...
        if (!empty($voucher_no)) {
            ...
            redirect('machinery/used/show', 'refresh');
        }
        ...
        $this->load->view($this->data['privilege'] . '/includes/headermenu', $this->data);
        $this->load->view('components/machinery/nav', $this->data);
        $this->load->view('components/machinery/preview', $this->data);
        $this->load->view($this->data['privilege'] . '/includes/footer');
    }
    ...
    public function edit()
    {
        ...
        $this->load->view($this->data['privilege'] . '/includes/headermenu', $this->data);
        $this->load->view('components/machinery/nav', $this->data);
        $this->load->view('components/machinery/edit', $this->data);
        $this->load->view($this->data['privilege'] . '/includes/footer');
    }
    ...
    public function store()
    {
        ...
        redirect('machinery/used/preview/'.$voucher_no, 'refresh');
    }
