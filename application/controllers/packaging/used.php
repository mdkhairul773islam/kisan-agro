...
class Used extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        //get all Product
        $this->data['allProducts'] = get_join('stock', 'materials', 'stock.code=materials.code AND stock.type=materials.type', ['stock.type' => 'raw', 'materials.raw_type' => 'packaging'], ['stock.code', 'stock.name']);
        ...
        $this->load->view('components/packaging/index', $this->data);
    ...
    public function show()
    {
        ...
        $this->load->view($this->data['privilege'] . '/includes/headermenu', $this->data);
        $this->load->view('components/packaging/nav', $this->data);
        $this->load->view('components/packaging/show-all', $this->data);
        $this->load->view($this->data['privilege'] . '/includes/footer');
    }
    ...
    public function item_wise_used()
    {
        ...
        $this->load->view($this->data['privilege'] . '/includes/headermenu', $this->data);
        $this->load->view('components/packaging/nav', $this->data);
        $this->load->view('components/packaging/item-wise-used', $this->data);
        $this->load->view($this->data['privilege'] . '/includes/footer');
    }
    ...
    {
        // get all result
        $where = ['tbl_packaging.trash' => 0, 'materials.raw_type' => 'packaging'];
        if (isset($_POST['show'])) {
    ...
    public function preview($voucher_no = null)
    {
        ...
        if (!empty($voucher_no)) {
            ...
            redirect('packaging/used/show', 'refresh');
        }
        ...
        $this->load->view($this->data['privilege'] . '/includes/headermenu', $this->data);
        $this->load->view('components/packaging/nav', $this->data);
        $this->load->view('components/packaging/preview', $this->data);
        $this->load->view($this->data['privilege'] . '/includes/footer');
    }
    ...
    public function edit()
    {
        ...
        $this->load->view($this->data['privilege'] . '/includes/headermenu', $this->data);
        $this->load->view('components/packaging/nav', $this->data);
        $this->load->view('components/packaging/edit', $this->data);
        $this->load->view($this->data['privilege'] . '/includes/footer');
    }
    ...
    public function store()
    {
        ...
        redirect('packaging/used/preview/'.$voucher_no, 'refresh');
    }
