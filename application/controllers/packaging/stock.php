...
class Stock extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        // get all product
        $this->data['all_product'] = get_result('materials', ['type' => 'raw', 'raw_type' => 'packaging', 'trash' => 0, 'status'=>'available'], ['code', 'name']);

        $where = ['stock.type' => 'raw', 'materials.trash' => 0, 'materials.raw_type' => 'packaging', 'materials.status'=>'available'];
        if (isset($_POST['show'])) {
        ...
        $this->load->view('components/packaging/stock', $this->data);
