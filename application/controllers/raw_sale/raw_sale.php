...
class Raw_sale extends Admin_Controller {
    ...
    public function index() {
        ...
        if(isset($_POST['save'])) {
        	...
        	redirect('raw_sale/viewRawSale?vno=' . $this->input->post('voucher_number'), 'refresh');
        }
        ...
        $this->load->view('components/raw_sale/add-sale', $this->data);
    ...
    public function itemWise() {
       ...
       if(isset($_POST['show'])){ 
        ...
        $this->load->view($this->data['privilege'] . '/includes/headermenu', $this->data);
        $this->load->view('components/raw_sale/nav', $this->data);
        $this->load->view('components/raw_sale/itemWise', $this->data);
        $this->load->view($this->data['privilege'] . '/includes/footer');
    }
    ...
    private function create() {
        ...
        $options = array(
            'title' => 'success',
            'emit'  => 'Product Raw Sale successfully Completed!',
            'btn'   => true
        );
