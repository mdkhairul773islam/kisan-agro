...
class SaleEditCtrl extends Admin_Controller {
    ...
    public function index() {
        ...
        if(isset($_POST['change'])) {
           ...
           /* $sign = ($this->input->post("current_sign") == 'Receivable') ? 'Payable' : 'Receivable';
            ...
            redirect("crushing_sale/saleEditCtrl?vno=". $_POST['voucher_no'], 'refresh');
        }
        ...
        $this->load->view('components/crushing_sale/edit-sale', $this->data);
    ...
    private function change(){
        ...
        $data = array(
            ...
            'paid'              => $this->input->post('previousPaid') + $this->input->post('paid')
        );
        ...
        $options = array(
            'title' => 'Updated',
            'emit'  => 'Crushing Product purchase successfully changed!',
            'btn'   => true
        );
