...
class Ajax extends Admin_Controller {
    ...
    public function result(){
        ...
        // get information from database
        $result = get_result($table, $where, $select, $groupBy, $order_col, $order_by, $limit, $where_in);
    ...
    public function left_join(){
        ...
        // get information from database
        $result = get_left_join($tableFrom, $tableTo, $joinCond, $where, $select, $groupBy, $order_col, $order_by, $limit);
    ...
    public function supplier_balance(){
        ...
        $party_code = $receive['party_code'];

        $result = get_supplier_balance($party_code);
    ...
    public function client_balance(){
        ...
        $result = get_client_balance($party_code);
    ...
    public function employee_salary(){
        ...
        $date   = $receive['payment_date'];

        $result = get_employee_salary($emp_id, $date);

        echo json_encode($result);
    }
    
    // get cc loan due
    public function cc_loan_info(){
        ...
        // get all balance
        $result = get_acc_info($receive['acc_no'],$receive['trx_date']);
